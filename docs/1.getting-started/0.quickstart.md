...
A modern Linux/macOS distribution with Python 3.11 installed is required to run DipDup. Also you need basic Python environment for install script, `python3.11 -m ensurepip`.
