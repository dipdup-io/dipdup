...
| `dipdup_contract_metadata` | See [Metadata interface](../5.advanced/12.metadata-interface.md).                                                                         |
| `dipdup_token_metadata`    | See [Metadata interface](../5.advanced/12.metadata-interface.md).                                                                         |
