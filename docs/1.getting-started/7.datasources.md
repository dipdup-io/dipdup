...
| --------------------------------------------------------------- | ---------------- | ----------------------------------------------- |
| [evm.subsquid](../3.datasources/1.evm_subsquid.md#v2-archive-gateway)   | ⟠ EVM-compatible | SQD Network v2.archive gateway                  |
| [evm.sqd_portal](../3.datasources/1.evm_subsquid.md#sqd-portal-gateway) | ⟠ EVM-compatible | SQD Network Portal gateway                      |
