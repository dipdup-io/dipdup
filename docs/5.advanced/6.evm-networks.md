...
| -----------------:|:------ | -------------------------------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok  | `https://v2.archive.subsquid.io/network/arbitrum-one`                            |
| **abi.etherscan** | 🟢 ok  | `https://api.arbiscan.io/api`                                                    |
|      **evm.node** | 🟢 ok  | `https://arb-mainnet.g.alchemy.com/v2` <br> `wss://arb-mainnet.g.alchemy.com/v2` |
...
|        datasource | status           | URLs                                                   |
| -----------------:|:---------------- | ------------------------------------------------------ |
|  **evm.subsquid** | 🟢 ok            | `https://v2.archive.subsquid.io/network/arbitrum-nova` |
| **abi.etherscan** | 🟢 ok            | `https://api-nova.arbiscan.io/api`                     |
...
|        datasource | status | URLs                                                                              |
| -----------------:|:------ | --------------------------------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok  | `https://v2.archive.subsquid.io/network/arbitrum-sepolia`                         |
| **abi.etherscan** | 🟢 ok  | `https://api-sepolia.arbiscan.io/api`                                             |
|      **evm.node** | 🟢 ok  | `https://arb-sepolia.g.alchemy.com/v2` </br> `wss://arb-sepolia.g.alchemy.com/v2` |
...
|        datasource | status        | URLs                                                   |
| -----------------:|:------------- | ------------------------------------------------------ |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/astar-mainnet` |
...
|        datasource | status        | URLs                                                   |
| -----------------:|:------------- | ------------------------------------------------------ |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/astar-zkatana` |
...
|        datasource | status       | URLs                                                                  |
| -----------------:|:------------ | --------------------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok        | `https://v2.archive.subsquid.io/network/avalanche-mainnet`            |
| **abi.etherscan** | 🟢 ok        | `https://api.routescan.io/v2/network/mainnet/evm/43114/etherscan/api` |
...
|        datasource | status       | URLs                                                  |
| -----------------:|:------------ | ----------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok        | `https://v2.archive.subsquid.io/network/base-mainnet` |
| **abi.etherscan** | 🟢 ok        | `https://api.basescan.org/api`                        |
...
|        datasource | status        | URLs                                                                  |
| -----------------:|:------------- | --------------------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/berachain-artio`              |
| **abi.etherscan** | 🟢 ok         | `https://api.routescan.io/v2/network/testnet/evm/80085/etherscan/api` |
|      **evm.node** | 🤔 not tested |                                                                       |
...
|        datasource | status | URLs                                                     |
| -----------------:|:------ | -------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok  | `https://v2.archive.subsquid.io/network/binance-mainnet` |
| **abi.etherscan** | 🟢 ok  | `https://api.bscscan.com/api`                            |
|      **evm.node** | 🟢 ok  | `https://go.getblock.io/` <br> `wss://go.getblock.io/`   |
...
|        datasource | status | URLs                                                     |
| -----------------:|:------ | -------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok  | `https://v2.archive.subsquid.io/network/binance-testnet` |
| **abi.etherscan** | 🟢 ok  | `https://api-testnet.bscscan.com/api`                    |
|      **evm.node** | 🟢 ok  | `https://go.getblock.io/` <br> `wss://go.getblock.io/`   |
...
|        datasource | status | URLs                                                                             |
| -----------------:|:------ | -------------------------------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok  | `https://v2.archive.subsquid.io/network/ethereum-mainnet`                        |
| **abi.etherscan** | 🟢 ok  | `https://api.etherscan.io/api`                                                   |
|      **evm.node** | 🟢 ok  | `https://eth-mainnet.g.alchemy.com/v2` <br> `wss://eth-mainnet.g.alchemy.com/v2` |
...
|        datasource | status        | URLs                                             |
| -----------------:|:------------- | ------------------------------------------------ |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/exosama` |
...
|        datasource | status        | URLs                                                    |
| -----------------:|:------------- | ------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/fantom-mainnet` |
| **abi.etherscan** | 🟢 ok         | `https://api.ftmscan.com/api`                           |
|      **evm.node** | 🤔 not tested |                                                         |
...
|        datasource | status        | URLs                                                    |
| -----------------:|:------------- | ------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/gnosis-mainnet` |
| **abi.etherscan** | 🟢 ok         | `https://api.gnosisscan.io/api`                         |
|      **evm.node** | 🤔 not tested |                                                         |
...
|        datasource | status | URLs                                                                      |
| -----------------:|:------ | ------------------------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok  | `https://v2.archive.subsquid.io/network/linea-mainnet`                    |
| **abi.etherscan** | 🟢 ok  | `https://api.lineascan.build/api`                                         |
|      **evm.node** | 🟢 ok  | `https://linea-mainnet.infura.io/v3` <br> `wss://mainnet.infura.io/ws/v3` |
...
|        datasource | status        | URLs                                                      |
| -----------------:|:------------- | --------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/moonbeam-mainnet` |
| **abi.etherscan** | 🟢 ok         | `https://api-moonbeam.moonscan.io/api`                    |
|      **evm.node** | 🤔 not tested |                                                           |
...
|        datasource | status        | URLs                                                   |
| -----------------:|:------------- | ------------------------------------------------------ |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/opbnb-mainnet` |
...
|        datasource | status | URLs                                                                             |
| -----------------:|:------ | -------------------------------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok  | `https://v2.archive.subsquid.io/network/optimism-mainnet`                        |
| **abi.etherscan** | 🟢 ok  | `https://api-optimistic.etherscan.io/api`                                        |
|      **evm.node** | 🟢 ok  | `https://opt-mainnet.g.alchemy.com/v2` <br> `wss://opt-mainnet.g.alchemy.com/v2` |
...
|        datasource | status | URLs                                                                                     |
| -----------------:|:------ | ---------------------------------------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok  | `https://v2.archive.subsquid.io/network/polygon-mainnet`                                 |
| **abi.etherscan** | 🟢 ok  | `https://api.polygonscan.com/api`                                                        |
|      **evm.node** | 🟢 ok  | `https://polygon-mainnet.g.alchemy.com/v2` <br> `wss://polygon-mainnet.g.alchemy.com/v2` |
...
|        datasource | status       | URLs                                                           |
| -----------------:|:------------ | -------------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok        | `https://v2.archive.subsquid.io/network/polygon-zkevm-mainnet` |
| **abi.etherscan** | 🟢 ok        | `https://api-zkevm.polygonscan.com/api`                        |
...
|        datasource | status        | URLs                                                           |
| -----------------:|:------------- | -------------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/polygon-zkevm-testnet` |
| **abi.etherscan** | 🟢 ok         | `https://api-testnet-zkevm.polygonscan.com/api`                |
|      **evm.node** | 🤔 not tested |                                                                |
...
| **abi.etherscan** | 🟢 ok        | `https://api.scrollscan.com/api` |
...
|        datasource | status        | URLs                                                    |
| -----------------:|:------------- | ------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/shiden-mainnet` |
| **abi.etherscan** | 🔴 no API     | N/A                                                     |
|      **evm.node** | 🤔 not tested |                                                         |
...
|        datasource | status | URLs                                                                                                                     |
| -----------------:|:------ | ------------------------------------------------------------------------------------------------------------------------ |
|  **evm.subsquid** | 🟢 ok  | `https://v2.archive.subsquid.io/network/skale-nebula`                                                                    |
| **abi.etherscan** | 🟢 ok  | `https://green-giddy-denebola.explorer.mainnet.skalenodes.com/api`                                                       |
|      **evm.node** | 🟢 ok  | `https://mainnet.skalenodes.com/v1/green-giddy-denebola` </br> `wss://mainnet.skalenodes.com/v1/ws/green-giddy-denebola` |
...
| -----------------:|:------------ | -------------------------------------- |
|  **evm.subsquid** | 🔴 no API    | N/A                                    |
| **abi.etherscan** | 🟢 ok        | `https://explorer.katla.taiko.xyz/api` |
...
|        datasource | status        | URLs                                                    |
| -----------------:|:------------- | ------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/tanssi`         |
...
|        datasource | status        | URLs                                                    |
| -----------------:|:------------- | ------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/zksync-mainnet` |
...
|        datasource | status        | URLs                                                                    |
| -----------------:|:------------- | ----------------------------------------------------------------------- |
|  **evm.subsquid** | 🟢 ok         | `https://v2.archive.subsquid.io/network/zora-mainnet`                   |
| **abi.etherscan** | 🟢 ok         | `https://api.routescan.io/v2/network/mainnet/evm/7777777/etherscan/api` |
|      **evm.node** | 🤔 not tested |                                                                         |
