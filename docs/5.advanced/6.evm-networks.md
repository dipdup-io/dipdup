...
|        datasource | supported | URLs                                                                                                                     |
| -----------------:|:--------- | ------------------------------------------------------------------------------------------------------------------------ |
|  **evm.subsquid** | 🟢 yes    | `https://v2.archive.subsquid.io/network/skale-nebula`                                                                    |
| **abi.etherscan** | 🟢 yes    | `https://green-giddy-denebola.explorer.mainnet.skalenodes.com/api`                                                       |
|      **evm.node** | 🟢 yes    | `https://mainnet.skalenodes.com/v1/green-giddy-denebola` </br> `wss://mainnet.skalenodes.com/v1/ws/green-giddy-denebola` |
