...
- Partially compatible with Cursor, VS Code, Claude Desktop, and other MCP clients. YMMV.
::
...
- [Copilot MCP](https://marketplace.visualstudio.com/items?itemName=AutomataLabs.copilot-mcp) (unmainained, see [#20](https://github.com/VikashLoomba/copilot-mcp/issues/20#issuecomment-2751896959))
