...
<div style="
    ...
    color: white;
    margin: 15px auto; /* Center the banner */
    border-radius: 5px;
    text-align: center; /* Center the text */
">
  <h2>Deprecation Notice</h2>
  <p>This documentation page is deprecated and may not represent the current state of the software. Please refer to the most recent version of the documentation for up-to-date information.</p>
</div>
