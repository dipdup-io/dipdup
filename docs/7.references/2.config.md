...
<li><p><strong>ignore</strong> (<em>list</em><em>[</em><em>str</em><em>]</em>) – List of table names to ignore when generating the GraphQL API.</p></li>
<li><p><strong>hide_internal</strong> (<em>bool</em>) – Whether to make internal tables private.</p></li>
<li><p><strong>hide</strong> (<em>list</em><em>[</em><em>str</em><em>]</em>) – List of table names to make private.</p></li>
