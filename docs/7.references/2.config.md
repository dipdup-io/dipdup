...
<li><p><strong>network</strong> (<a class="reference internal" href="#dipdupmodelstzip_metadatatzipmetadatanetwork" title="dipdup.models.tzip_metadata.TzipMetadataNetwork"><em>TzipMetadataNetwork</em></a>) – Network name, e.g. mainnet, ghostnet, etc.</p></li>
