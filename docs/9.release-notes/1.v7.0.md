...
The project package structure was significantly updated and is now easier to extend. All sections are created on init and pre-filled with stubs. Also, it's flat now, meaning that package is also a project root directory.
