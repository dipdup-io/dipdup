...
- Multiple feature flags were added for experimental and rarely used features. See the [Feature flags](../5.advanced/1.feature-flags.md) page. `metadata_interface` flag was removed, now it's always enabled.
