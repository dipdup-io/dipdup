...
See the [Docker](../6.deployment/1.docker.md) page in the docs.
...
- Multiple feature flags were added for experimental and rarely used features. See the [Feature flags](../5.advanced/1.environment-variables.md) page. `metadata_interface` flag was removed, now it's always enabled.
...
- You can use long syntax to configure logging, a mapping of logger name and loglevel. See the [Logging](../6.deployment/4.logging.md) page.
