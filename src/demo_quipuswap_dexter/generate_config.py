...
CONFIG_NAME = 'dipdup-gen.yml'

GET_ORIGINATED_CONTRACTS = 'https://api.tzkt.io/v1/accounts/{}/contracts?limit=10000'
GET_TOKENS = 'https://api.better-call.dev/v1/contract/mainnet/{}/tokens'
GET_STORAGE = 'https://api.tzkt.io/v1/contracts/{}/storage'
