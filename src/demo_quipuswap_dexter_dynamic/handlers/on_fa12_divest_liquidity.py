...
from demo_quipuswap_dexter.types.quipu_fa12.parameter.divest_liquidity import DivestLiquidityParameter
...
async def on_fa12_divest_liquidity(
    ...
    divest_liquidity: TransactionContext[DivestLiquidityParameter, QuipuFa12StorageT],
