...
from demo_substrate_events_orm import models as models
from demo_substrate_events_orm.types.assethub.substrate_events.assets_transferred import AssetsTransferredPayload
