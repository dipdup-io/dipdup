# FIXME: All max_digits increased by 10 for PostgreSQL. No idea why.
...
class Factory(CachedModel):
    ...
    total_volume_usd = fields.DecimalField(decimal_places=2, max_digits=20, default=0)
    # total volume all time in derived ETH
    total_volume_eth = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # total swap fees all time in USD
    total_fees_usd = fields.DecimalField(decimal_places=2, max_digits=20, default=0)
    # total swap fees all time in USD
    total_fees_eth = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # all volume even through less reliable USD values
    untracked_volume_usd = fields.DecimalField(decimal_places=2, max_digits=20, default=0)
    # TVL derived in USD
    total_value_locked_usd = fields.DecimalField(decimal_places=2, max_digits=20, default=0)
    # TVL derived in ETH
    total_value_locked_eth = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # TVL derived in USD untracked
    total_value_locked_usd_untracked = fields.DecimalField(decimal_places=2, max_digits=20, default=0)
    # TVL derived in ETH untracked
    total_value_locked_eth_untracked = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
...
class Token(CachedModel):
    ...
    # fees in USD
    fees_usd = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # transactions across all pools that include this token
    tx_count = fields.BigIntField(default=0)
    # number of pools containing this token
    pool_count = fields.BigIntField(default=0)
    # liquidity across all pools in token units
    total_value_locked = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # liquidity across all pools in derived USD
    total_value_locked_usd = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # TVL derived in USD untracked
    total_value_locked_usd_untracked = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # derived price in ETH
    derived_eth = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
...
class Pool(CachedModel):
    ...
    # in range liquidity
    liquidity = fields.DecimalField(decimal_places=0, max_digits=82, default=0)
    # current price tracker
    sqrt_price = fields.DecimalField(decimal_places=0, max_digits=82, default=0)
    ...
    # token0 per token1
    token0_price = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # token1 per token0
    token1_price = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # current tick
    tick = fields.BigIntField(null=True)
    # current observation index
    observation_index = fields.BigIntField(default=0)
    # all time token0 swapped
    volume_token0 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # all time token1 swapped
    volume_token1 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    ...
    collected_fees_token0 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # all time fees collected token1
    collected_fees_token1 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # all time fees collected derived USD
    collected_fees_usd = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # total token 0 across all ticks
    total_value_locked_token0 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # total token 1 across all ticks
    total_value_locked_token1 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # tvl derived ETH
    total_value_locked_eth = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # tvl USD
    total_value_locked_usd = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
...
class Tick(Model):
    ...
    liquidity_gross = fields.DecimalField(decimal_places=0, max_digits=82, default=0)
    # how much liquidity changes when tick crossed
    liquidity_net = fields.DecimalField(decimal_places=0, max_digits=82, default=0)
    # calculated price of token0 of tick within this pool - constant
    price0 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # calculated price of token1 of tick within this pool - constant
    price1 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
...
class Position(Model):
    ...
    liquidity = fields.DecimalField(max_digits=82, decimal_places=0, default=0)
    # amount of token 0 ever deposited to position
    deposited_token0 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # amount of token 1 ever deposited to position
    deposited_token1 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # amount of token 0 ever withdrawn from position (without fees)
    withdrawn_token0 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # amount of token 1 ever withdrawn from position (without fees)
    withdrawn_token1 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # all time collected fees in token0
    collected_fees_token0 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # all time collected fees in token1
    collected_fees_token1 = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
...
class Mint(Model):
    ...
    amount = fields.DecimalField(decimal_places=0, max_digits=82, default=0)
    ...
    amount_usd = fields.DecimalField(decimal_places=18, max_digits=82, null=True)
    # lower tick of the position
...
class Flash(Model):
    ...
    amount0_paid = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # amount token1 paid for flash
    amount1_paid = fields.DecimalField(decimal_places=18, max_digits=82, default=0)
    # index within the txn
    log_index = fields.BigIntField()
