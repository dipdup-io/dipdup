...
class Factory(Model):
    ...
    total_volume_usd = fields.DecimalField(decimal_places=2, max_digits=10, default=0)
    # total volume all time in derived ETH
    total_volume_eth = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # total swap fees all time in USD
    total_fees_usd = fields.DecimalField(decimal_places=2, max_digits=10, default=0)
    # total swap fees all time in USD
    total_fees_eth = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # all volume even through less reliable USD values
    untracked_volume_usd = fields.DecimalField(decimal_places=2, max_digits=10, default=0)
    # TVL derived in USD
    total_value_locked_usd = fields.DecimalField(decimal_places=2, max_digits=10, default=0)
    # TVL derived in ETH
    total_value_locked_eth = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # TVL derived in USD untracked
    total_value_locked_usd_untracked = fields.DecimalField(decimal_places=2, max_digits=10, default=0)
    # TVL derived in ETH untracked
    total_value_locked_eth_untracked = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
...
class Token(Model):
    ...
    volume = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # volume in derived USD
    volume_usd = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # volume in USD even on pools with less reliable USD values
    untracked_volume_usd = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # fees in USD
    fees_usd = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # transactions across all pools that include this token
    tx_count = fields.BigIntField(default=0)
    # number of pools containing this token
    pool_count = fields.BigIntField(default=0)
    # liquidity across all pools in token units
    total_value_locked = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # liquidity across all pools in derived USD
    total_value_locked_usd = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # TVL derived in USD untracked
    total_value_locked_usd_untracked = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # derived price in ETH
    derived_eth = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
...
class Pool(Model):
    ...
    collected_fees_usd = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
...
class Tick(Model):
    ...
    liquidity_gross = fields.DecimalField(decimal_places=0, max_digits=72, default=0)
    # how much liquidity changes when tick crossed
    liquidity_net = fields.DecimalField(decimal_places=0, max_digits=72, default=0)
    # calculated price of token0 of tick within this pool - constant
    price0 = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # calculated price of token1 of tick within this pool - constant
    price1 = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
...
class Position(Model):
    ...
    tick_lower: fields.ForeignKeyRelation[Tick] = fields.ForeignKeyField(
        'models.Tick',
        related_name='positions_tick_lower',
    )
    # upper tick of the position
    tick_upper: fields.ForeignKeyRelation[Tick] = fields.ForeignKeyField(
        'models.Tick',
        related_name='positions_tick_upper',
    )
    # total position liquidity
    liquidity = fields.DecimalField(max_digits=72, decimal_places=0, default=0)
    # amount of token 0 ever deposited to position
    deposited_token0 = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # amount of token 1 ever deposited to position
    deposited_token1 = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # amount of token 0 ever withdrawn from position (without fees)
    withdrawn_token0 = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # amount of token 1 ever withdrawn from position (without fees)
    withdrawn_token1 = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # all time collected fees in token0
    collected_fees_token0 = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # all time collected fees in token1
    collected_fees_token1 = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
...
class Mint(Model):
    ...
    amount = fields.DecimalField(decimal_places=0, max_digits=72, default=0)
    # amount of token 0 minted
    amount0 = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # amount of token 1 minted
    amount1 = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
    # derived amount based on available prices of tokens
    amount_usd = fields.DecimalField(decimal_places=18, max_digits=72, null=True)
    # lower tick of the position
...
class Flash(Model):
    ...
    amount0_paid = fields.DecimalField(decimal_places=18, max_digits=72, default=0)
