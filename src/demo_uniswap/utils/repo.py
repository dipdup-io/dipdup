...
class ModelsRepo:
    def __init__(self) -> None:
        self._factories: dict[str, models.Factory] = {}
        self._pools: dict[str, models.Pool] = {}
        self._tokens: dict[str, models.Token] = {}
        self._positions: dict[str, models.Position] = {}
        self._eth_usd: Optional[Decimal] = None

    async def get_factory(self, factory_address: str) -> models.Factory:
        return await models.Factory.get(id=factory_address)
    ...
    async def get_pool(self, pool_address: str) -> models.Pool:
        return await models.Pool.get(id=pool_address)
    ...
    async def get_position(self, token_id: str) -> Optional[models.Position]:
        return await models.Position.get_or_none(id=token_id)
