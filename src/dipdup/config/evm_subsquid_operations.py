...
@dataclass
class EvmSubsquidOperationsUnfilteredIndexConfig(IndexConfig):
    """Operation index config
...
EvmSubsquidOperationsIndexConfigU = EvmSubsquidOperationsIndexConfig | EvmSubsquidOperationsUnfilteredIndexConfig
