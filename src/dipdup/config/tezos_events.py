...
from dipdup.models.tezos import EventSubscription
...
class TezosEventsHandlerConfig(HandlerConfig):
    ...
    def iter_imports(self, package: str) -> Iterator[tuple[str, str]]:
        ...
        yield 'dipdup.models.tezos_tzkt', 'TezosTzktEvent as Event'
...
class TezosEventsUnknownEventHandlerConfig(HandlerConfig):
    ...
    def iter_imports(self, package: str) -> Iterator[tuple[str, str]]:
        yield 'dipdup.context', 'HandlerContext'
        yield 'dipdup.models.tezos_tzkt', 'TezosTzktUnknownEvent as UnknownEvent'
        yield package, 'models as models'
